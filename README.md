1. **Messenger Analytics User   Documentation**
    ...
    **Usage:**
    ...
    - The left graph shows number of messages per date, the green line represents the exact number of messages on given day and the red line represents moving avarage of given range.
